...
def create_scene():
    ...
    scene = {
        ...
        "components": [
            ...
            {
                "component": "TheMatrix",
                "kwargs": {"matrix": [[0, -1, 1], [1, 0, -1], [-1, 1, 0]],},
            },
        ],
    }
    return scene
...
def create_prefabs():
    ...
    prefabs["resource_class1"] = create_resource_prefab(
        1,
        shapes.BUTTON,
        {"*": RESOURCE1_COLOR_DATA[0], "#": RESOURCE1_COLOR_DATA[1], "x": (0, 0, 0, 0)},
    )
    prefabs["resource_class2"] = create_resource_prefab(
        2,
        shapes.BUTTON,
        {"*": RESOURCE2_COLOR_DATA[0], "#": RESOURCE2_COLOR_DATA[1], "x": (0, 0, 0, 0)},
    )
    prefabs["resource_class3"] = create_resource_prefab(
        3,
        shapes.BUTTON,
        {"*": RESOURCE3_COLOR_DATA[0], "#": RESOURCE3_COLOR_DATA[1], "x": (0, 0, 0, 0)},
    )
    return prefabs
