...
REACTIVITY_LEVELS = {
    "ground": {"background": 0.00001, "low": 0.005, "medium": 0.001, "high": 0.9},
    "stomach": {"background": 0.0, "low": 0.0025, "medium": 0.25, "high": 0.9},
}
...
def cycle(
    g, reaction_prefix, intermediates, product, secondary_product=None, food="food"
):
...
def create_avatar_objects(prefabs, num_players):
    ...
    for player_idx in range(0, num_players):
        ...
        game_object_utils.get_first_named_component(avatar_stomach, "AvatarStomach")[
            "kwargs"
        ]["playerIndex"] = (player_idx + 1)
