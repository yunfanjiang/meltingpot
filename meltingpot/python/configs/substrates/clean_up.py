    ...
    "components": [
        {
            ...
            "kwargs": {
                ...
                "stateConfigs": [
                    {"state": "apple", "sprite": "Apple", "layer": "lowerPhysical",},
                    {"state": "appleWait"},
                ],
            },
        },
        ...
        "components": [
            {
                ...
                "kwargs": {
                    ...
                    "stateConfigs": [
                        {"state": "dirtWait", "layer": "logic",},
                        {"state": "dirt", "layer": "lowerPhysical", "sprite": "Dirt",},
                    ],
                },
            },
            {
            ...
            },
            {
                ...
                "kwargs": {"activeState": "dirt", "inactiveState": "dirtWait",},
            },
...
def create_avatar_object(
    ...
    avatar_object = {
        ...
        "components": [
            ...
            {
                "component": "Cleaner",
                "kwargs": {"cooldownTime": 2, "beamLength": 3, "beamRadius": 1,},
            },
            {"component": "Taste", "kwargs": {"role": "free", "rewardAmount": 1,}},
            {
