...
REWARD_INDICATOR = {
    ...
    "components": [
        ...
        {"component": "Transform", "kwargs": {"position": (0, 0), "orientation": "N"}},
        {"component": "RewardIndicator", "kwargs": {}},
    ],
}
...
for j, color in enumerate(colors.palette[:MAX_ALLOWED_NUM_PLAYERS]):
    ...
    game_object_utils.get_first_named_component(RESOURCE, "StateManager")["kwargs"][
        "stateConfigs"
    ].append(
        {
    ...
    game_object_utils.get_first_named_component(RESOURCE, "Appearance")["kwargs"][
        "spriteNames"
    ].append(sprite_name)
    game_object_utils.get_first_named_component(RESOURCE, "Appearance")["kwargs"][
        "spriteRGBColors"
        ...
        "components": [
            ...
            },
            {
                ...
                "kwargs": {
                    ...
                    "actionOrder": ["move", "turn", "fireZap", "fireClaim"],
                    "actionSpec": {
            ...
            {"component": "Taste", "kwargs": {"role": "none", "rewardAmount": 1.0,}},
        ],
    }
