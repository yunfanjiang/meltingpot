...
CHAR_PREFAB_MAP = {
    ...
    "W": "wall",
    "D": {"type": "choice", "list": ["destroyable_wall"] * 9 + ["destroyed_wall"]},
    "H": {"type": "choice", "list": ["destroyable_wall"] * 3 + ["destroyed_wall"]},
    ",": "ground",
...
TEAMS_DATA = {
    ...
    "blue": {"color": BLUE_COLOR, "spawn_group": "{}SpawnPoints".format("blue")},
}
    ...
    "components": [
        {
            ...
            "kwargs": {
                "initialState": "inert",
                "stateConfigs": [
                    {"state": "inert", "layer": "superOverlay", "sprite": "InertFrame"}
                ],
            },
        },
        {"component": "Transform",},
        {
            ...
            "kwargs": {
                ...
                "palettes": [
                    {"*": (0, 0, 0, 0), "x": (55, 55, 55, 255), "#": (0, 0, 0, 0)}
                ],
                "noRotates": [True],
            },
        },
    ...
    "components": [
        {
            ...
            "kwargs": {
                ...
                "stateConfigs": [
                    ...
                    {"state": "red", "layer": "background", "sprite": "RedIndicator",},
                    {
                        "state": "blue",
                        "layer": "background",
        ...
        "components": [
            {
                ...
                "kwargs": {
                    "initialState": "inert",
                    "stateConfigs": [
                        {"state": "inert", "layer": "background", "sprite": sprite_name}
                    ],
                },
            },
            {"component": "Transform",},
            {
                ...
                "kwargs": {
                    ...
                    "spriteShapes": [shapes.BUTTON],
                    "palettes": [
                        {"*": (0, 0, 0, 0), "x": (0, 0, 0, 0), "#": (218, 165, 32, 255)}
                    ],
                    "noRotates": [True],
                },
            },
            {"component": "HomeTile", "kwargs": {"team": team,}},
        ],
    }
    return prefab
        ...
        "components": [
            {
                ...
                "kwargs": {
                    "initialState": "clean",
                    "stateConfigs": [
                        {"state": "clean", "layer": "alternateLogic",},
                        {
                            "state": "red",
            ...
            {"component": "Ground", "kwargs": {"teamNames": ["red", "blue"],}},
        ],
    }
    return prefab
        ...
        "components": [
            ...
            {"component": "Transform",},
            {
                ...
                "kwargs": {
                    ...
                    "spriteShapes": [shapes.FLAG, shapes.FLAG_HELD],
                    "palettes": [shapes.get_palette(flag_color)] * 2,
                    "noRotates": [True, True],
                },
            },
            {"component": "Flag", "kwargs": {"team": team,}},
        ],
    }
    return prefab
...
def create_avatar_object(
    player_idx: int, team: str, override_taste_kwargs: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    ...
    avatar_object = {
        ...
        "components": [
            ...
            },
            {
                ...
                "kwargs": {"zapperComponent": "ColorZapper",},
            },
            {
...
def _even_vs_odd_team_assignment(num_players, taste_kwargs: Optional[Any] = None):
...
def _low_vs_high_team_assignment(num_players, taste_kwargs: Optional[Any] = None):
...
def create_avatar_objects(
    num_players, taste_kwargs: Optional[Any] = None, fixed_teams: Optional[bool] = False
):
    ...
    lab2d_settings = {
        ...
        "simulation": {
            ...
            "gameObjects": create_avatar_objects(
                num_players, taste_kwargs=avatar_taste_kwargs, fixed_teams=fixed_teams
            ),
            "scene": create_scene(),
            "prefabs": PREFABS,
