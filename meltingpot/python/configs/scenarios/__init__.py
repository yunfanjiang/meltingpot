...
SCENARIOS: Mapping[str, Scenario] = immutabledict.immutabledict(
    ...
    allelopathic_harvest_1=Scenario(
        ...
        tags=frozenset({"convention_following", "visitor",}),
        substrate="allelopathic_harvest",
        num_focal_agents=4,
    ...
    arena_running_with_scissors_in_the_matrix_2=Scenario(
        ...
        tags=frozenset({"half_and_half", "versus_pure_rock",}),
        substrate="arena_running_with_scissors_in_the_matrix",
        num_focal_agents=4,
        num_background_bots=4,
        bots=frozenset(
    ...
    arena_running_with_scissors_in_the_matrix_3=Scenario(
        ...
        tags=frozenset({"half_and_half", "versus_pure_paper",}),
        substrate="arena_running_with_scissors_in_the_matrix",
        num_focal_agents=4,
        num_background_bots=4,
        bots=frozenset(
    ...
    arena_running_with_scissors_in_the_matrix_4=Scenario(
        ...
        tags=frozenset({"half_and_half", "versus_pure_scissors",}),
        substrate="arena_running_with_scissors_in_the_matrix",
        num_focal_agents=4,
        num_background_bots=4,
        bots=frozenset(
    ...
    bach_or_stravinsky_in_the_matrix_0=Scenario(
        ...
        tags=frozenset({"convention_following", "versus_pure_bach", "visitor",}),
        substrate="bach_or_stravinsky_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset({"bach_fan_0", "bach_fan_1", "bach_fan_2",}),
    ),
    bach_or_stravinsky_in_the_matrix_1=Scenario(
        description="visiting pure stravinsky fans",
        tags=frozenset({"convention_following", "versus_pure_stravinsky", "visitor",}),
        substrate="bach_or_stravinsky_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset({"stravinsky_fan_0", "stravinsky_fan_1", "stravinsky_fan_2",}),
    ),
    capture_the_flag_0=Scenario(
        description="focal team versus shaped a3c bot team",
        tags=frozenset({"half_and_half", "learned_teamwork",}),
    ...
    capture_the_flag_2=Scenario(
        ...
        tags=frozenset({"ad_hoc_teamwork", "visitor",}),
        substrate="capture_the_flag",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset(
    ...
    chicken_in_the_matrix_1=Scenario(
        ...
        tags=frozenset({"versus_pure_dove", "visitor",}),
        substrate="chicken_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset(
    ...
    chicken_in_the_matrix_2=Scenario(
        ...
        tags=frozenset({"resident", "versus_pure_hawk",}),
        substrate="chicken_in_the_matrix",
        num_focal_agents=5,
    ...
    chicken_in_the_matrix_3=Scenario(
        ...
        tags=frozenset({"deception", "versus_free", "visitor",}),
        substrate="chicken_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset(
            {"chicken_free_0", "chicken_free_1", "chicken_free_2", "chicken_free_3",}
        ),
    ),
    chicken_in_the_matrix_4=Scenario(
        description="visiting grim reciprocators",
        tags=frozenset({"reciprocity", "versus_puppet", "visitor",}),
        substrate="chicken_in_the_matrix",
        num_focal_agents=2,
        num_background_bots=6,
        bots=frozenset({"chicken_puppet_grim",}),
    ),
    clean_up_0=Scenario(
        description="visiting an altruistic population",
        tags=frozenset({"versus_cleaners", "visitor",}),
        substrate="clean_up",
        num_focal_agents=3,
        num_background_bots=4,
        bots=frozenset({"cleanup_cleaner_1", "cleanup_cleaner_2",}),
    ),
    clean_up_1=Scenario(
        description="focals are resident and visitors free ride",
        tags=frozenset({"resident", "versus_consumers",}),
        substrate="clean_up",
        num_focal_agents=4,
        num_background_bots=3,
        bots=frozenset(
            {"cleanup_consumer_0", "cleanup_consumer_1", "cleanup_consumer_2",}
        ),
    ),
    clean_up_2=Scenario(
        description="visiting a turn-taking population that cleans first",
        tags=frozenset({"versus_puppet", "visitor",}),
        substrate="clean_up",
        num_focal_agents=3,
        num_background_bots=4,
        bots=frozenset({"cleanup_puppet_alternate_clean_first",}),
    ),
    clean_up_3=Scenario(
        ...
        num_focal_agents=3,
        num_background_bots=4,
        bots=frozenset({"cleanup_puppet_alternate_eat_first",}),
    ),
    clean_up_4=Scenario(
        description="focals are visited by one reciprocator",
        tags=frozenset({"resident", "versus_puppet",}),
        substrate="clean_up",
        num_focal_agents=6,
        num_background_bots=1,
        bots=frozenset({"cleanup_puppet_reciprocator_threshold_low",}),
    ),
    clean_up_5=Scenario(
        ...
        bots=frozenset({"cleanup_puppet_reciprocator_threshold_mid",}),
    ),
    clean_up_6=Scenario(
    ...
    collaborative_cooking_passable_0=Scenario(
        ...
        tags=frozenset(
            {"convention_following", "versus_uncoordinated_generalist", "visitor",}
        ),
        substrate="collaborative_cooking_passable",
        num_focal_agents=1,
        num_background_bots=3,
        bots=frozenset({"collaborative_cooking_passable_vmpo_pop_size_ten_5",}),
    ),
    collaborative_cooking_passable_1=Scenario(
        description="focals are resident and visited by an uncoordinated generalist",
        tags=frozenset({"resident", "versus_uncoordinated_generalist",}),
        substrate="collaborative_cooking_passable",
        num_focal_agents=3,
        num_background_bots=1,
        bots=frozenset({"collaborative_cooking_passable_vmpo_pop_size_ten_5",}),
    ...
    commons_harvest_open_0=Scenario(
        ...
        num_focal_agents=14,
        num_background_bots=2,
        bots=frozenset({"open_commons_zapper_0", "open_commons_zapper_1",}),
    ),
    ...
    commons_harvest_partnership_0=Scenario(
        ...
        tags=frozenset({"half_and_half", "versus_good_partners",}),
    ...
    commons_harvest_partnership_1=Scenario(
        ...
        tags=frozenset({"resident", "versus_good_partners",}),
        substrate="commons_harvest_partnership",
        num_focal_agents=12,
        num_background_bots=4,
        bots=frozenset(
    ...
    commons_harvest_partnership_2=Scenario(
        ...
        tags=frozenset({"versus_good_partners", "visitor",}),
        substrate="commons_harvest_partnership",
        num_focal_agents=4,
        num_background_bots=12,
        bots=frozenset(
    ...
    commons_harvest_partnership_3=Scenario(
        description="focals are resident and visited by two zappers",
        tags=frozenset({"resident", "versus_zappers",}),
        substrate="commons_harvest_partnership",
        num_focal_agents=14,
        num_background_bots=2,
        bots=frozenset(
            {"partnership_commons_zapper_1", "partnership_commons_zapper_2",}
        ),
    ),
    ...
    commons_harvest_partnership_5=Scenario(
        description="visiting a population of zappers",
        tags=frozenset({"versus_zappers", "visitor",}),
        substrate="commons_harvest_partnership",
        num_focal_agents=4,
        num_background_bots=12,
        bots=frozenset(
    ...
    prisoners_dilemma_in_the_matrix_2=Scenario(
        ...
        tags=frozenset({"resident", "versus_pure_defectors",}),
        substrate="prisoners_dilemma_in_the_matrix",
        num_focal_agents=6,
        num_background_bots=2,
        bots=frozenset(
            {"prisoners_dilemma_defector_0", "prisoners_dilemma_defector_2",}
        ),
    ),
    ...
    prisoners_dilemma_in_the_matrix_4=Scenario(
        ...
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset({"prisoners_dilemma_puppet_grim_threshold_high",}),
    ),
    prisoners_dilemma_in_the_matrix_5=Scenario(
        ...
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset({"prisoners_dilemma_puppet_grim_threshold_low",}),
    ),
    pure_coordination_in_the_matrix_0=Scenario(
        description="focals are resident and visitor is mixed",
        tags=frozenset({"resident", "versus_pure_all",}),
    ...
    pure_coordination_in_the_matrix_1=Scenario(
        ...
        tags=frozenset({"versus_pure_type_1", "visitor",}),
        substrate="pure_coordination_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset(
    ...
    pure_coordination_in_the_matrix_2=Scenario(
        ...
        tags=frozenset({"versus_pure_type_2", "visitor",}),
        substrate="pure_coordination_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset(
    ...
    pure_coordination_in_the_matrix_3=Scenario(
        ...
        tags=frozenset({"versus_pure_type_3", "visitor",}),
        substrate="pure_coordination_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset(
    ...
    running_with_scissors_in_the_matrix_0=Scenario(
        ...
        num_background_bots=1,
        bots=frozenset(
            {"classic_rws_free_0", "classic_rws_free_1", "classic_rws_free_2",}
        ),
    ),
    ...
    stag_hunt_in_the_matrix_0=Scenario(
        ...
        tags=frozenset({"versus_pure_stag", "visitor",}),
        substrate="stag_hunt_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset({"stag_hunt_stag_specialist_3", "stag_hunt_stag_specialist_5",}),
    ),
    stag_hunt_in_the_matrix_1=Scenario(
        description="visiting a population of hares",
        tags=frozenset({"versus_pure_hare", "visitor",}),
        substrate="stag_hunt_in_the_matrix",
        num_focal_agents=1,
        num_background_bots=7,
        bots=frozenset(
    ...
    stag_hunt_in_the_matrix_2=Scenario(
        ...
        num_focal_agents=2,
        num_background_bots=6,
        bots=frozenset({"stag_hunt_puppet_grim",}),
    ),
