...
from meltingpot.python.configs.substrates import (
    arena_running_with_scissors_in_the_matrix as mp_arena_rws_itm,
)
from meltingpot.python.configs.substrates import (
...
from meltingpot.python.configs.substrates import (
    pure_coordination_in_the_matrix as mp_pure_coord_itm,
)
from meltingpot.python.configs.substrates import (
    rationalizable_coordination_in_the_matrix as mp_rational_coord_itm,
)
from meltingpot.python.configs.substrates import (
    running_with_scissors_in_the_matrix as mp_rws_itm,
)
from meltingpot.python.configs.substrates import (
...
def main():
    ...
    parser.add_argument(
        "--level_name",
        type=str,
        default="mp_prisoners_dilemma_in_the_matrix",
