...
def apply_prefab_overrides(
    lab2d_settings: config_dict.ConfigDict, prefab_overrides: Optional[Settings] = None
):
  ...
  """
    ...
    if build_avatars_here:
        ...
        avatar_objects = game_object_utils.build_avatar_objects(
            int(lab2d_settings.numPlayers), lab2d_settings.simulation.prefabs, palettes
        )
        lab2d_settings.simulation.gameObjects += avatar_objects


def locate_and_overwrite_level_directory(lab2d_settings: config_dict.ConfigDict):
